...
import com.backend_microservices.admin_service.client.AuditClient;
import com.backend_microservices.admin_service.dto.AuditLog;
...
public class AuditLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            log.setServiceName("admin-service");
            log.setEndpoint(uri);
    ...
    private String resolveAction(String uri) {
        if (uri.contains("snapshot")) {
            return "VIEW_DASHBOARD_SNAPSHOT";
        } else if (uri.contains("users") && uri.contains("ban")) {
            return "BAN_USER";
        } else if (uri.contains("users") && uri.contains("promote")) {
            return "PROMOTE_USER";
